        ...
        <Box sx={{ flexGrow: 1 }}>
          ...
          <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
            <Tabs value={tabValue} onChange={handleTabChange} centered sx={{ mb: 3 }}>
              <Tab icon={<CalculateIcon />} label="Single Calculation" />
              <Tab icon={<UploadFileIcon />} label="CSV Processing" />
              <Tab icon={<SettingsIcon />} label="Configuration" />
            </Tabs>

            <Box sx={{ mt: 3 }}>
              {tabValue === 0 && <Calculator />}
          ...
          <Box sx={{ bgcolor: 'background.paper', p: 3, mt: 8 }} component="footer">
            <Typography variant="body2" color="text.secondary" align="center">
              Motor Insurance Premium Calculator v1.0.0
            </Typography>
            <Typography variant="body2" color="text.secondary" align="center">
