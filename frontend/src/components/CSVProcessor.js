...
const CSVProcessor = () => {
  ...
  const downloadSampleCSV = () => {
    const sampleData = `cc_category,zone,purchase_date,idv,ncb_percent,od_discount_percent,nil_dep,engine_protection,consumables,cpa_owner_driver
1000cc_1500cc,A,2024-01-01,125000,20,60,1,1,1,1
upto_1000cc,B,2020-06-15,75000,50,40,0,0,0,1
above_1500cc,A,2023-03-20,200000,30,50,1,1,1,1`;
